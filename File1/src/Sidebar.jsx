...
export default function Sidebar() {
  ...
  return (
    <NavigationDrawer header={<Header />}>
      ...
      <Destination className="self-end" href="https://192.168.149.59/api/events" text="API" />
      <Destination className="self-end" href="https://ai.ai-solutions.com/Contact" text="Contact" />
    </NavigationDrawer>
  );
}
